...
import { Globe, Building2, GraduationCap, Award, ShieldCheck } from 'lucide-react';
...
const ecosystems = [
  ...
  { name: 'IIT Ropar', lucideIcon: GraduationCap, role: 'Advitiya \'26 Cyber Forge', badge: 'Finalist' },
  { name: 'MRIIRS Conference', lucideIcon: Award, role: 'Peer-Reviewed AI Health Research', badge: 'Presented 2026' },
  { name: 'NSUT', lucideIcon: Building2, role: 'Hackathon Collaboration', badge: 'Engineering Team' },
  { name: 'Hack Paradox', lucideIcon: ShieldCheck, role: 'Cybersecurity Scam Detection', badge: 'Sentinel AI' },
];
    ...
    <div className="mb-10 animate-fade-in space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
        {ecosystems.map((eco, idx) => {
          const LucideComp = eco.lucideIcon;
          return (
            <motion.div
              key={idx}
