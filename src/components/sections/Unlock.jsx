...
export const Unlock = ({ onUnlock }) => {
  ...
  return (
    ...
    >
      ...
      <div className="text-text-secondary font-mono text-lg flex items-center justify-center space-x-2">
      ...
      <div className="pt-12 text-[10px] text-text-secondary/40 uppercase tracking-[0.2em]">
