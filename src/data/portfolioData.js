...
export const terminalBootLinesCompact = [
  "   ██╗ █████╗ ██╗   ██╗ █████╗ ███╗  ██╗████████╗",
  "   ██║██╔══██╗╚██╗ ██╔╝██╔══██╗████╗ ██║╚══██╔══╝",
  "   ██║███████║ ╚████╔╝ ███████║██╔██╗██║   ██║   ",
  "██ ██║██╔══██║  ╚██╔╝  ██╔══██║██║╚████║   ██║   ",
...
export const bootSequence = [
  { text: "Initializing portfolio system...", delay: 50 },
  { text: "Loading design tokens...", delay: 80 },
  { text: "Mounting component library...", delay: 100 },
  { type: "progress", duration: 600 },
  { text: "done", type: "status", color: "text-[#00B050]", delay: 50 },
  { text: "", delay: 150 },
  { text: "Resolving 12 case studies...", delay: 100 },
  { text: "Connecting to Product Rocket core...", delay: 120 },
  { text: "ok", type: "status", color: "text-[#00B050]", delay: 50 },
  { text: "", delay: 150 },
  { text: "Design systems: operational", delay: 60 },
  { text: "UX research modules: loaded", delay: 60 },
  { text: "Don't search for /secrets here...", delay: 60 },
